...
public class SimDraw extends SampleView{
	/**
	 * 
	 */
	...
	public void initModel() {
		super.elbowanglemax = Math.toRadians(135.0);
		super.elbowanglemin = Math.toRadians(0.0);
		super.shoulderanglemax = Math.toRadians(90.0);	
		super.shoulderanglemin = Math.toRadians(0.0);	
